...
mod test {
    ...
    #[test]
    fn uuids() {
        assert!(super::SERVICE_UUID.parse::<Uuid>().is_ok());
        assert!(super::CHARACTERISTIC_TEXT_UUID.parse::<Uuid>().is_ok());
        assert!(super::CHARACTERISTIC_STATUS_UUID.parse::<Uuid>().is_ok());
        assert!(super::CHARACTERISTIC_COMMAND_UUID.parse::<Uuid>().is_ok());
    }
}